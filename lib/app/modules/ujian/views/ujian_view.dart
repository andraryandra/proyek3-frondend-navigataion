        ...
        child: Column(
          ...
          color: Colors.white,
            ...
            Container(
              child: Column(
                ...
                children: [
                  SizedBox(height: 20,),
                  Text(
                    'Image Merupakan  kumpulan dari titik-titik dengan gradasi warna tertentu yang membentuk pola tertentu, di komputer titik-titik tertentu tersebut berbentuk kotak bujur sangkar dan disebut....',
            ...
            Container(
              ...
              child: Center(
                child: Text('selanjutnya',style: TextStyle(color: Colors.white,fontWeight: FontWeight.w500),),
              ),
            ),
          ],
        ),
